...
data6 = "190 2 3\n 40 5 6"
results6 = numpy.genfromtxt(StringIO(data6), delimiter=(3, 2, 2), usecols=(0, 2))
print(results6)
...
190 2 3
40 5 6"""
results7 = numpy.genfromtxt(StringIO(data7), comments="#")
print(results7)
...
190 2 3
40 5 6"""
results8 = numpy.genfromtxt(StringIO(data8), skip_header=2)
print(results8)

data9 = """
190 2 3.45
40 5 6.98"""
results9 = numpy.genfromtxt(
    StringIO(data9), dtype=(numpy.uint8, numpy.uint8, numpy.float16)
)
print(results9)
