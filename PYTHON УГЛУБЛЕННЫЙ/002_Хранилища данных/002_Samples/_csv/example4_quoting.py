...
with open("data/output.csv", "w") as f:
    ...
    writer = csv.DictWriter(
        f, fieldnames=["first_name", "last_name", "age"], quoting=quoting
    )
    ...
    writer.writerow(
        {"first_name": "Ivan", "last_name": "Petrov @ ll, A_Draft", "age": 20}
    )
    writer.writerow({"first_name": "Dmitry", "last_name": "Sidorov", "age": 30})
    writer.writerow({"first_name": "Alexey", "last_name": "Ivanov", "age": 30})
