...
from src.resources.populate_db import (PopulateDB, PopulateDBThreaded,
                                       PopulateDBThreadPoolExecutor)
...
api.add_resource(
    PopulateDBThreadPoolExecutor, "/populate_db_executor", strict_slashes=False
)
