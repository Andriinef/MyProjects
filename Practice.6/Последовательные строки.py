...
testing0 = assert_equals(longest_consec(["zone", "abigail", "theta", "form", "libe", "zas"], 2), "abigailtheta")
...
testing4 = assert_equals(longest_consec(["wlwsasphmxx", "owiaxujylentrklctozmymu", "wpgozvxxiu"], 2),
                         "wlwsasphmxxowiaxujylentrklctozmymu")
testing5 = assert_equals(longest_consec(["zone", "abigail", "theta", "form", "libe", "zas"], -2), "")
testing6 = assert_equals(longest_consec(["it", "wkppv", "ixoyx", "3452", "zzzzzzzzzzzz"], 3), "ixoyx3452zzzzzzzzzzzz")
testing7 = assert_equals(longest_consec(["it", "wkppv", "ixoyx", "3452", "zzzzzzzzzzzz"], 15), "")
testing8 = assert_equals(longest_consec(["it", "wkppv", "ixoyx", "3452", "zzzzzzzzzzzz"], 0), "")
