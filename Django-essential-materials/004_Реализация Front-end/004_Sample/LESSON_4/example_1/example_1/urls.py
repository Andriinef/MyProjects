...
from itvdn_shop.views import (CreateViewExample, DateDetailViewExample,
                              DeleteExample, DetailViewExample, Index,
                              ListExample, LoginExample, Report, UpdateExample,
